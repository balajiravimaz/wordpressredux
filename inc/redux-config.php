...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__('Header Fields', 'redux-starter'),
		'id'               => 'header',
		'desc'             => esc_html__('These are really basic header fields!', 'redux-starter'),
...
Redux::setSection($opt_name, array(
	'title' => esc_html__('Copy Rights', 'redux-starter'),
	'id'    => 'footer-copy',
	'customizer_width' => '700px',
	'desc' => esc_html__('Copy Rights Reserved', 'redux-starter'),
	'fields' => array(
		array(
			'id' => 'foot-rights',
			'type' => 'text',
			'title' => esc_html__('Copyrights', 'redux-starter'),
			'default' => 'Copyrights @2020 All rights reserved',
		),
	)
));
...
Redux::setSection($opt_name, array(
	'title' => esc_html__('The Footer-1', 'redux-starter'),
	'id'    => 'footer-text',
	'customizer_width' => '700px',
	'desc' => esc_html__('These are footer fields', 'redux-starter'),
	'fields' => array(
		array(
			'id' => 'foot-add',
			'type' => 'text',
			'title' => esc_html__('Adress', 'redux-starter'),
			'default' => 'Your Address'
		),
		array(
			'id' => 'foot-phone',
			'type' => 'text',
			'title' => esc_html__('Phone', 'redux-starter'),
			'default' => 'xxxxx'
		),
		array(
			'id' => 'foot-web',
			'type' => 'text',
			'title' => esc_html__('Website', 'redux-starter'),
			'default' => 'https://sample.com'
		),
		array(
			'id' => 'foot-email',
			'type' => 'text',
			'title' => esc_html__('Email', 'redux-starter'),
			'default' => 'samle@gmail.com'
		),
		Redux::setSection($opt_name, array(
			'title' => esc_html__('The Footer-2', 'redux-starter'),
			'id'    => 'footer-text2',
			'customizer_width' => '700px',
			'desc' => esc_html__('These are footer fields', 'redux-starter'),
			'fields' => array(
				array(
					...
					'type' => 'text',
					'title' => esc_html__('Adress', 'redux-starter'),
					'default' => 'Put your shortcode contact form'
				),
			)
		))
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__('Logo switch', 'redux-starter'),
		'id'         => 'switch_but',
		'desc'       => esc_html__('Upload Your Logo', 'redux-starter'),
		'subsection' => true,
		'fields'     => array(
			...
			array(
				'id'       => 'switch-parent-1',
				'type'     => 'switch',
				'title'    => esc_html__('Upload Your logo, Enable to show', 'redux-starter'),
				'subtitle' => esc_html__('Logo any formats', 'redux-starter'),
				'default'  => 0,
				'on'       => 'Enabled',
				'off'      => 'Disabled',
			),
			array(
				...
				'title'    => esc_html__('Logo icon', 'your-textdomain-here'),
				'desc'     => esc_html__('Logo url', 'your-textdomain-here'),
				'default'  => false,
			),
			array(
				'id'       => 'logo-text',
				'type'     => 'text',
				'required' => array('switch-parent-1', '=', false),
				'title'    => esc_html__('Enter Logo title', 'your-textdomain-here'),
				'desc'     => esc_html__('Enter Logo Text', 'your-textdomain-here'),
				'default'  => false,
			),
			array(
				'id'           => 'opt-media-1',
				...
				'url'          => true,
				'title'        => esc_html__('Upload your logo', 'your-textdomain-here'),
				'compiler'     => 'true',
				'desc'         => esc_html__('Upload Your logo', 'your-textdomain-here'),
				'preview_size' => 'full',
			),
